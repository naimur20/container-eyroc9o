...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-eyroc9o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-eyroc9o.containers.anotherwebservice.com/
...
```
git clone git@github.com:naimur20/container-eyroc9o.git
cd container-eyroc9o
```
...
```
docker attach container-eyroc9o
```
